                                    ...
                                    <g clipPath="url(#clip1_1_285)">
                                        <g clipPath="url(#clip2_1_285)">
                                            ...
                                            <g mask="url(#mask0_1_285)">
                                                <path d="M14.5714 16.2858C15.0261 16.2858 15.4621 16.1052 15.7835 15.7837C16.105 15.4622 16.2857 15.0262 16.2857 14.5715" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100"/>
                                                <path d="M7.71423 16.2856H10.2857" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100"/>
                                                <path d="M16.2857 7.71436V10.2858" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round"className="group-hover:stroke-primary/100" />
                                                <path d="M9.42851 7.71436C8.97386 7.71436 8.53783 7.89497 8.21633 8.21646C7.89484 8.53795 7.71423 8.97399 7.71423 9.42865" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round"className="group-hover:stroke-primary/100" />
                                                <path d="M0.857117 2.57147C0.857117 2.11681 1.03773 1.68077 1.35922 1.35928C1.68071 1.03779 2.11675 0.857178 2.5714 0.857178H14.5714C15.0261 0.857178 15.4621 1.03779 15.7836 1.35928C16.105 1.68077 16.2857 2.11681 16.2857 2.57147V7.71432H21.4285C21.8832 7.71432 22.3192 7.89494 22.6407 8.21642C22.9622 8.53791 23.1428 8.97395 23.1428 9.4286V21.4286C23.1428 21.8833 22.9622 22.3193 22.6407 22.6408C22.3192 22.9623 21.8832 23.1429 21.4285 23.1429H9.42854C8.97388 23.1429 8.53785 22.9623 8.21636 22.6408C7.89487 22.3193 7.71426 21.8833 7.71426 21.4286V16.2858H2.5714C2.11675 16.2858 1.68071 16.1051 1.35922 15.7836C1.03773 15.4621 0.857117 15.0261 0.857117 14.5714V2.57147Z" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100"/>
                                                <path d="M13.7142 7.71436H16.2857" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100"/>
                                                <path d="M7.71423 13.7144V16.2858" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100"/>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                                ...
                                <g clipPath="url(#clip0_1_335)">
                                    <g clipPath="url(#clip1_1_335)">
                                        ...
                                        <g mask="url(#mask0_1_335)">
                                            <path d="M21.4286 0.857178H2.57141C1.62463 0.857178 0.857117 1.62469 0.857117 2.57147V21.4286C0.857117 22.3754 1.62463 23.1429 2.57141 23.1429H21.4286C22.3753 23.1429 23.1428 22.3754 23.1428 21.4286V2.57147C23.1428 1.62469 22.3753 0.857178 21.4286 0.857178Z" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M12 19.7143C15.3137 19.7143 18 17.028 18 13.7143C18 10.4007 15.3137 7.71436 12 7.71436C8.68629 7.71436 6 10.4007 6 13.7143C6 17.028 8.68629 19.7143 12 19.7143Z" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M0.857117 6H5.99998" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M18 6H23.1428" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M12 13.6628V19.6628" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M6.85712 10.6287L12 13.6629" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                            <path d="M17.1428 10.6287L12 13.6629" stroke="white" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-primary/100" />
                                        </g>
                                    </g>
                                </g>
                            </svg>
