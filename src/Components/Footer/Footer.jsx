...
const Footer = () => {
    return (
        <div className='bg-[radial-gradient(circle_at_top,#47348C_0%,#161A2D_100%)] pt-20'>
            <Container>
                <div className='flex justify-between items-center'>
                    <div>
                        <Heading className='text-white w-159.5'>
                ...
                <div className='grid grid-cols-[5fr_7fr] gap-0 border border-t-white/10 border-l-0 border-r-0 border-b-0 py-20 mt-20'>
                    <div className='w-90'>
                        <div>
